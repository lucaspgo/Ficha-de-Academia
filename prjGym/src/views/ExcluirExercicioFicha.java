...
public class ExcluirExercicioFicha {
	public static void renderizar(Usuario u, int diaSemana) {
		ListarGrupoMuscular.renderizar();
		int opcaoGrupoMuscular = Console.readInt("Escolha grupo muscular para excluir:");
		...
		if(grupoMuscularRetornado != null) {			
			...
			if(ListarExerciciosPorGrupoMuscular.renderizar(opcaoGrupoMuscular)) {
				...
				int idExercicio = Console.readInt("Qual exercício você deseja excluir da ficha?\n");
				...
				default:
					...
					if(exercicioRetornado != null) {
						FichaDAO.excluirExercicioaFicha(exercicioRetornado, u, diaSemana);					
